...
>
> This project integrates Unison for ns-3 multi-threaded parallel simulation; see [UNISON_README.md](UNISON_README.md) and [QUICK_START_en.md](QUICK_START_en.md) for usage details ([EuroSys '24 paper](https://dl.acm.org/doi/10.1145/3627703.3629574)).
