...
#include "ns3/mtp-interface.h" // Added for UNISON
#include <chrono>
#include <iostream>
#include <iomanip>
#include <sstream>
...
{
    // Enable MTP with default number of threads (or auto-detect)
    MtpInterface::Enable(); 
    ...
    // Skip trace analysis for quick benchmark if desired, but keep it for completeness
